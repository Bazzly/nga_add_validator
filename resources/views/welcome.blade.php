...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Home | Nigeria Address Validator</title>
...
<div class="py-12 bg-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Nigeria Address Validation system</h2>
        <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
          A better way to verify real nigeria address
        </p>
        <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            Inaccurate addresses can cause millions of Naira worth of problems
        </p>
      </div>
        ...
        <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
          <div class="relative">
            <dt>
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Accuracy</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
                Address Verification Technology Built on local base map for presiced accuracy
            </dd>
          </div>
          ...
          <div class="relative">
            <dt>
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Solve location base problem</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
                Have a location based problem? this can solve it.
            </dd>
          </div>
          ...
          <div class="relative">
            ...
            <dd class="mt-2 ml-16 text-base text-gray-500">
                This is a free to use nigeria address validator . you can buy us a cofee to suport us to do more
            </dd>
          </div>
        </dl>
      </div>
